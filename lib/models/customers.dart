...
class Customer {
  ...
  factory Customer.fromJson(dynamic json) {
    return Customer(
      ...
      buildingNo: json[CustomerFields.buildingNo] as String,
      streetName: json[CustomerFields.streetName] as String,
      district: json[CustomerFields.district] as String,
      city: json[CustomerFields.city] as String,
      country: json[CustomerFields.country] as String,
      postalCode: json[CustomerFields.postalCode] as String,
      additionalNo: json[CustomerFields.additionalNo] as String,
      vatNumber: json[CustomerFields.vatNumber] as String,
      contactNumber: json[CustomerFields.contactNumber] as String,
    );
  }
